...
# WIP - from https://www.sherweb.com/blog/cloud-server/fun-with-powershell-the-less-than-simple-way-to-scan-an-ip-range/ 

# define the range  
[string]$firstThree = “10.2.25”
[int]$startRange = 100  
[int]$endRange = 200  
...
# sort the results  
$results = $results | Sort-Object @{Expression={$_[0]}; Ascending=$false}  
# report the results  
